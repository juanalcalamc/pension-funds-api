Pension Fund API
Descripción
Este proyecto implementa una API RESTful para la gestión de fondos de pensiones. Permite administrar clientes, fondos, suscripciones, cancelaciones y transacciones, con soporte para notificaciones automáticas.

Está construido con:

FastAPI como framework principal.

SQLAlchemy para ORM y modelado de base de datos.
